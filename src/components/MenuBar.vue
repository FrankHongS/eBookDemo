        ...
        <div class='setting-theme' v-else-if='showTag === 1'>
          ...
          >
            <div
              ...
              :class='{ "has-border": item.style.body.background === "#fff" }'
              @click='setTheme(index)'
            ></div>
            <div class='desc' :class='{ active: index === currentTheme }'>
              {{ item.name }}
            </div>
          </div>
        </div>
